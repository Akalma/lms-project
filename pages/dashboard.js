  ...
  return (
	...
	<Formik enableReinitialize
          ...
          <div className="controls">
            <div className="row">
              <div className="col-md-6">
                <div className="form-group" >
					...
					<Field type="text" required="required" className={'form-control' + (errors.first_name && touched.first_name ? ' is-invalid' : '')} name="first_name" />
			  ...
			  <label>Last Name</label>
                <div className="form-group">
				<Field type="text" required="required" className={'form-control' + (errors.last_name && touched.last_name ? ' is-invalid' : '')} name="first_name" name="last_name" id="last_name" />
			  ...
			  <div className="col-md-12">
			   <label>Mobile</label>
                <div className="form-group">
				<Field type="tel" required="required" className={'form-control' + (errors.mobile && touched.mobile ? ' is-invalid' : '')} name="mobile" id="mobile" />
			...
			<li><input type="submit" value="Reset" className="lightBtn" /></li>
